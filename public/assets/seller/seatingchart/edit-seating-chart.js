...
var pos,stage,stage_edit_tooltip_option,selectedtableshape,selectedmenuoption,shapeaddE;
...
$(document).ready(function() {
    setTimeout(function(){
        ...
        json = format(json, "selectionrectangle");
        $.each(json.children, function(i,item) {
            if(i == 0 || i == 1) {
                json.children[i] = '';
            }
        });
        layer = Konva.Node.create(json,'play-ground');
        stage.add(layer);
        layer.add(tr);
