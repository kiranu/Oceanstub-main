    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-default">
          ...
          <form name="CategoryForm" id="CategoryForm" action="{{url('admin/seller_plan/'.$seller_plan->id)}}"
            ...
            <div class="row">
              ...
              <div class="col-md-6">
				...
				<div class="form-group" >
                    ...
                    <input type="name" class="form-control"  name="name" placeholder="Enter Brand Name" value="{{$seller_plan->name}}" required> 
                  </div>
                   <div class="form-group">
					<label><strong>Description :</strong></label></br>
					
						<textarea id="summernote1"  name="desc" >{!!$seller_plan->desc!!}</textarea> 
					</div>
                  <div class="form-group" >
                    <label for="brand_code">Plan Validity</label>
                    <input type="number" class="form-control"  name="validity" placeholder="Enter Validity in days" value="{{$seller_plan->validity}}" required> 
                  </div>
                   <div class="form-group" >
                    <label for="brand_code">Plan Amount</label>
                    <input type="number" class="form-control"  name="price" placeholder="Enter Price" value="{{$seller_plan->price}}" required> 
                  </div>
