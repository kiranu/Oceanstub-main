...
<div class="card-body">
           ...
           <table id="sections" class="table table-bordered table-striped">
                 ...
                 <td>
                 @if($ticket->start_sale_date != null)
                 {{$ticket->start_sale_date." on ".$ticket->start_sale_time}}
                 @else
                  Not Specified
                 @endif
                 </td>
                 <td>
                 @if($ticket->end_sale_date != null)

                 {{$ticket->end_sale_date." on ".$ticket->end_sale_time}}
                  @else
                  Not Specified
                 @endif
                 </td>
