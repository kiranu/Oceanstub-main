    ...
    <form id="ticket-form">
        <div class=" cWizStep6" style="padding-left:10px; display: inline-block;">
            <span for="ctl02_cTax" class="editLabel">
                Tax %</span>
            <input name="tax" type="number" value="0.00" maxlength="5" id="Tax" class="form-control editText" data-validation-number="float" data-validation-number-min="0" style="width:85px;display: inline-block;" data-validation-avoid-success-tick="1" min="0">
        </div>
        <br>
        <br>
        ...
        <div class="row  cWizStep6 cCapCapacity" style="padding-left:20px;">
            <span class="cCheckboxV2">
                <input id="CapCapacity" type="checkbox" name="cap" value="yes" onchange="checkboxcapa(this.checked)">
        ...
        <div class="showHidecapacity" style="margin-top:10px;margin-left: 0px; display: none;">
            ...
            <input name="cap_capacity" type="number" value="" maxlength="5" id="CapCapacityNo" class="editText" data-validation-number="float" data-validation-number-min="0" style="width:85px;margin-left: 40px; " data-validation-avoid-success-tick="1" min="0">
            <p class="hint" style="padding-left: 30px;font-size: small;">Maximum number of tickets to sell across all price levels due to social distancing restrictions</p>
        </div>
        <br>
...
<div class="card-body p-0">
    ...
    <table id="PriceTableA" class="table" style="border-bottom: 1px solid;
    margin-bottom: 50px;
...
@if($ticket_prices != null)
<h3 class="devider ColTextHighlight" style="color: #007bff"><i class="fas fa-info-circle"></i>&nbsp;&nbsp;  Tickets Status:
</h3>
<hr>
...
@endisset
    ...
    <div class=" cAdv  cTextV2 " style="padding-left: 10px;">
        ...
        <input name="note" type="text" maxlength="100" id="Note" class="form-control editText ticketoptio" style="width:391px;" data-validation-avoid-success-tick="1">
    ...
    <div class="row  cTextV2 " style="padding-left:15px;">
        ...
        <select name="color" id="color" class="col-md-4 form-control editText cTicketDesigns" data-validation-avoid-success-tick="1">
    ...
    <div class="row  cWizStep6 cCapCapacity" style="padding-left:20px;">
        <span class="cCheckboxV2">
            <input id="CapCapacity" type="checkbox" value="1" name="hide_buyer">
            <span class="checkmark" style="margin-left: 5px;">
