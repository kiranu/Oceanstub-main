<div class="card-body">
    <!--
        <div class="tab-content" id="custom-tabs-one-tabContent">
            <div class="tab-pane fade" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab">
                <h3 class="devider ColTextHighlight"   style="color: #007bff";><i class="fa fa-envelope fa-15x  "></i>&nbsp;&nbsp;Delivery methods:
                </h3>
                <hr>
                <p class="hint">Select what delivery methods buyers can choose during the checkout.&nbsp;&nbsp;<a href="" target="_blank">(learn more)</a></p>
                <div class="row2" style="padding-bottom:20px;">
                    <table id="ctl02_cDeliveryOptions" class="editText deliveryOptions " border="0">
                        <tbody>
                            <tr>
                                <td><input id="ctl02_cDeliveryOptions_0" type="checkbox" name="ctl02$cDeliveryOptions$0" checked="checked"><span for="ctl02_cDeliveryOptions_0">Will-Call (Venue pickup): No Charge - 0 Hours</span></td>
                            </tr>
                            <tr>
                                <td><input id="ctl02_cDeliveryOptions_1" type="checkbox" name="ctl02$cDeliveryOptions$1" checked="checked"><span for="ctl02_cDeliveryOptions_1">e-Ticket (Print or show on your phone): No Charge - 0 Hours</span></td>
                            </tr>
                        </tbody>
                    </table>
                    <a target="_blank" class="cAddDelivery ColTextHighlight" style="padding-left: 200px;" href=""><i class="fa fa-plus-circle fa-hover fa-15x"></i>&nbsp;&nbsp;Add/Edit delivery methods&nbsp;<sup><i class="fa fa-external-link"></i></sup></a>
                </div>
            </div>
        </div>
        -->
    ...
    <form id="policy_form">
        <div class="row clearfix  cTextV2 "style="padding-left:10px;">
            <select name="return_policy" id="return_policy" class="editText cReturnPolicy" onchange="getval(this)"data-validation-avoid-success-tick="1">
                <option  value="0">No returns - All sales are final</option>
        ...
        <div class="cReturn return-accept" style="margin-left: 20px; display: none;">
            ...
            <div class="row">
                <input name="ReturnUpToHoursBefore" type="number"  min="0" maxlength="5" class="editText cReturnHoursBefore valid" data-validation-number="UInt" style="width:85px;" aria-describedby="cValMsg281453">
            ...
            <br>
            <div class="row">
                <input name="DeductionStoreCredit" type="number"  min="0" maxlength="5"  class="editText" data-validation-number="float" style="width:85px;">
            ...
            <br>
            <div class="row">
                <input name="DeductionCreditCard" type="number"  min="0" maxlength="5"  class="editText" data-validation-number="float" style="width:85px;">
        ...
        <div class="row2 clearfix cTextV2  " style="padding-left: 10px ;">
            ...
            <select name="ExchangePolicy" id="ctl02_cExchangePolicy"  onchange="getcategory(this)"; class="editText cExchangePolicy exchangeupgrade" data-validation-avoid-success-tick="1" style="width:80%">
                <option selected="selected" value="0">No exchange - All sales are final</option>
                <option  value="1">Exchange / upgrade accepted within the same event (no refund)</option>
                <option value="2">Exchange / upgrade accepted within the same event and other recurrences of this event (no refund)</option>
                <option value="3">Exchange / upgrade accepted within the same event and events in following category (no refund):</option>
                <option value="4">Exchange / upgrade accepted within the same event and events from the same event organizer (no refund):</option>
                <option value="5">Exchange / upgrade accepted with any event (no refund)</option>
            </select>
        </div>
        <br>
        <div class="row cExchangeCategories cateExchange" style="display:none;padding-left: 15px ;">
            ...
            <input name="ExchangeCategories" type="text" maxlength="100" id="ctl02_cExchangeCategories" class="editText " data-validation-required="1" style="width:291px;margin-left: 5px;">
        </div>
        <br>
        <!-- error -->
        <div class="cExchange" style="display: none;padding-left: 15px ;">
            <div class="row"style="padding-left:10px;">
                ...
                <input name="ExchangeHoursBefore" type="number" value="" maxlength="5" id="ctl02_cExchangeHoursBefore" class="editText cExchangeHoursBefore" data-validation-number="UInt" min="0" style="width:55px;">
