        ...
        <div class="card-body">
            <div class="tab-content" id="custom-tabs-one-tabContent">
                <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel" aria-labelledby="custom-tabs-one-home-tab"style="padding-left:30px;">
                    ...
                    @endif
        <form method="post" action="{{route('seller.updatepackage')}}" enctype="multipart/form-data">
            @csrf
                    <div class="form-group row"style="padding-left:10px;">
                        <span for="inputPassword3" class="col-sm-2 col-form-label">Package name:</span>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="inputPassword3" name="first_title" value={{$package->first_title}} placeholder="" required>
                    ...
                    <div class="form-group row"style="padding-left:10px;">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="second_title" value={{$package->second_title}} class="form-control" id="inputPassword3" placeholder="">
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="" style="padding-top: 20px;padding-left:10px;">
                        ...
                        <select size="4" name="event_type"  id="ctl02_cEventType" class="cEventType" style="width:251px;">
                            <option value="AmusementPark" {{ $package->event_type == 'AmusementPark' ? 'selected':'' }}>Amusement Park</option>
                            <option value="AppearanceOrSigning" {{ $package->event_type == 'AppearanceOrSigning' ? 'selected':'' }}>Appearance or Signing</option>
                            <option value="Attraction" {{ $package->event_type == 'Attraction' ? 'selected':'' }}>Attraction</option>
                            <option value="AwardsCeremony" {{ $package->event_type == 'AwardsCeremony' ? 'selected':'' }}>Awards / Ceremony</option>
                            <option value="CampTriporRetreat" {{ $package->event_type == 'CampTriporRetreat' ? 'selected':'' }}>Camp, Trip, or Retreat</option>
                            <option value="Class" {{ $package->event_type == 'Class' ? 'selected':'' }}>Class</option>
                            <option value="Concert" {{ $package->event_type == 'Concert' ? 'selected':'' }}>Concert</option>
                            <option value="Conference" {{ $package->event_type == 'Conference' ? 'selected':'' }}>Conference</option>
                    ...
                    <div class="" style="padding-top: 20px;padding-left:10px;">
                        ...
                        <select size="4" name="event_genre" id="ctl02_cEventGenre" class="cEventGenre" style="width:251px;">
                            <option value="AutoBoat_Air" {{ $package->event_genre == 'AutoBoat_Air' ? 'selected':'' }}>Auto, Boat &amp; Air</option>
                            <option value="Adult" {{ $package->event_genre == 'Adult' ? 'selected':'' }}>Adult</option>
                            <option value="Business_Professional" {{ $package->event_genre == 'Business_Professional' ? 'selected':'' }}>Business / Professional</option>
                            <option value="Charity_Causes" {{ $package->event_genre == 'Charity_Causes' ? 'selected':'' }}>Charity / Causes</option>
                            <option value="Comedy" {{ $package->event_genre == 'Comedy' ? 'selected':'' }}>Comedy</option>
                            <option value="Community" {{ $package->event_genre == 'Community' ? 'selected':'' }}>Community</option>
                            <option value="Culture" {{ $package->event_genre == 'Culture' ? 'selected':'' }}>Culture</option>
                            <option value="Education" {{ $package->event_genre == 'Education' ? 'selected':'' }}>Education</option>
                            <option value="Entertainment" {{ $package->event_genre == 'Entertainment' ? 'selected':'' }}>Entertainment</option>
                            <option value="Foodanddrink" {{ $package->event_genre == 'Foodanddrink' ? 'selected':'' }}>Food and drink</option>
                            <option value="Fashion_Beauty" {{ $package->event_genre == 'Fashion_Beauty' ? 'selected':'' }}>Fashion / Beauty</option>
                            <option value="Government_Politics" {{ $package->event_genre == 'Government_Politics' ? 'selected':'' }}>Government / Politics</option>
                            <option value="Health_wellbeing" {{ $package->event_genre == 'Health_wellbeing' ? 'selected':'' }}>Health / Wellbeing</option>
                            <option value="History_Heritage" {{ $package->event_genre == 'History_Heritage' ? 'selected':'' }}>History / Heritage</option>
                            <option value="Hobbies_SpecialInterest" {{ $package->event_genre == 'Hobbies_SpecialInterest' ? 'selected':'' }}>Hobbies / Special interest</option>
                            <option value="Kids" {{ $package->event_genre == 'Kids' ? 'selected':'' }}>Kids</option>
                            <option value="Lifestyle" {{ $package->event_genre == 'Lifestyle' ? 'selected':'' }}>Lifestyle</option>
                            <option value="Magic" {{ $package->event_genre == 'Magic' ? 'selected':'' }}>Magic</option>
                            <option value="Media_film" {{ $package->event_genre == 'Media_film' ? 'selected':'' }}>Media / film</option>
                            <option value="Music" {{ $package->event_genre == 'Music' ? 'selected':'' }}>Music</option>
                            <option value="Privatefriends_family_grou" {{ $package->event_genre == 'Privatefriends_family_grou' ? 'selected':'' }}>Private (friends / family / group)</option>
                            <option value="Performing_VisualArts" {{ $package->event_genre == 'Performing_VisualArts' ? 'selected':'' }}>Performing / Visual Arts</option>
                            <option value="SchoolActivities" {{ $package->event_genre == 'SchoolActivities' ? 'selected':'' }}>School Activities</option>
                            <option value="Religion_Spirituality" {{ $package->event_genre == 'Religion_Spirituality' ? 'selected':'' }}>Religion / Spirituality</option>
                            <option value="Science_Technology" {{ $package->event_genre == 'Science_Technology' ? 'selected':'' }}>Science / Technology</option>
                            <option value="Seasonal_Holiday" {{ $package->event_genre == 'Seasonal_Holiday' ? 'selected':'' }}>Seasonal / Holiday</option>
                            <option value="Sports_fitness" {{ $package->event_genre == 'Sports_fitness' ? 'selected':'' }}>Sports / fitness</option>
                            <option value="Supernatural" {{ $package->event_genre == 'Supernatural' ? 'selected':'' }}>Supernatural</option>
                            <option value="Theatre" {{ $package->event_genre == 'Theatre' ? 'selected':'' }}>Theatre</option>
                            <option value="Travel_Tours" {{ $package->event_genre == 'Travel_Tours' ? 'selected':'' }}>Travel / Tours</option>
                            <option value="Other" {{ $package->event_genre == 'Other' ? 'selected':'' }}>Other</option>
                        </select>
                        {{-- <p class="hint"style="font-size:14px;">Hold down the Ctrl (windows) or Command (Mac) button to select multiple options.</p> --}}
                    </div>
                    <br>
                    ...
                    <div class="row2" style="padding-left:10px;">
                        ...
                        <span class="">
                        <input name="start_date" value="@if(isset($package->start_date_time)){{date('Y-m-d', strtotime($package->start_date_time))}}@endif"  type="date"  maxlength="10" id="ctl00_CPMain_cPackageEdit_cStartDateView" class="cDatePicker cStartDateView hasDatepicker" data-validation-required="1" data-validation-avoid-success-tick="1" style="width:160px;direction:ltr;border-color:inherit;">
                        <input name="start_time" value="@if(isset($package->start_date_time)){{date('H:i', strtotime($package->start_date_time))}}@endif" type="time"  maxlength="10" id="ctl00_CPMain_cPackageEdit_cStartTimeView" class="cTimePicker hasTimepicker" data-validation-required="1" data-validation-avoid-success-tick="1" style="width:85px;border-color:inherit;">
                        </span>
                    ...
                    <div class="row2"style="padding-left:10px;">
                        ...
                        <span class="">
                        <input name="end_date"  type="date" value="@if(isset($package->end_date_time)){{date('Y-m-d', strtotime($package->end_date_time))}}@endif" maxlength="10" id="ctl00_CPMain_cPackageEdit_cEndDateView" class="cDatePicker cEndDateView hasDatepicker" data-validation-required="1" data-validation-avoid-success-tick="1" style="width:160px;border-color:inherit;">
                        <input name="end_time" type="time" value="@if(isset($package->end_date_time)){{date('H:i', strtotime($package->end_date_time))}}@endif" maxlength="10" id="ctl00_CPMain_cPackageEdit_cEndTimeView" class="cTimePicker cEndTimeView hasTimepicker" data-validation-required="1" data-validation-avoid-success-tick="1" style="width:85px;border-color:inherit;">
                        </span>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab"style="padding-left:20px;">
                    ...
                    use App\Models\Event;
                        ...
                        // $selectevents=$package['event_list'];
                        // dd($selectevents);
                   @endphp
                    <div class="row2"style="margin-left:5px;">
                        <select multiple class="select2" name="events[]" id="events" data-placeholder="Select Events" style="margin-left:5px;width: 266px;" required>
                            ...
                            <option value="{{$event->id}}" @foreach ($package['event_list'] as $selectedevent) {{ $selectedevent->event_id == $event->id ? 'selected':'' }} @endforeach>{{$event->first_title}} </option>
                            @endforeach
                                ...
                                <div class="row imgContainer" style="padding-left:10px;">
                                    <div class="cImageUploader" style="text-align:center;" data-type="EventFlyer" data-uploadfilename="209443" data-noimage="">
                                        ...
                                        <div class="row ticket-upload"style="padding-left: 340px;">
                                            <img id="previewImg" src="@if(isset($package->image)){{url($package->image)}}@endif" style="border-width:1px;border-style:solid;     border-radius: 20px;width: 200px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cSeatingChartContainer cAdv">
                                ...
                                <div class="row cSeatingChartContainer"style="padding-left:10px;">
                                    <table id="ctl02_cVideoType" class="leftAlign" border="0">
                                        <tbody>
                                            <tr>
                                                <td><input id="ctl02_cVideoType_0" type="radio" name="video_link_type" value="Youtube" {{ $package->video_link_type == 'Youtube' ? 'checked':'' }}><span for="ctl02_cVideoType_0"style="padding-left: 20px; ">YouTube Video - https://YouTube.com/watch?v=VIDEO_ID</span></td>
                                            </tr>
                                ...
                                <br>
                                <span style="padding-left: 10px; ">Youtube ID: <input name="youtube_link" value="{{$package->youtube_link}}" type="text" maxlength="20" id="ctl02_cVideo"></span><br>
                                ...
                                <div class="row cSeatingChartContainer"style="padding-left:10px;">
                                    <table id="ctl02_cVideoType" class="leftAlign" border="0">
                                        <tbody>
                                            <tr>
                                                <td><input id="ctl02_cVideoType_1" type="radio" name="video_link_type" value="Facebook" {{ $package->video_link_type == 'Facebook' ? 'checked':'' }}><span for="ctl02_cVideoType_1"style="padding-left: 20px; ">Facebook Video - https://facebook.com/video.php?v=VIDEO_ID</span></td>
                                            </tr>
                                ...
                                <span style="padding-left: 10px; ">Facebook ID: <input name="facebook_link" value="{{$package->facebook_link}}" type="text" maxlength="20" id="ctl02_cVideo"></span><br>
                    ...
                    <div id="options" style="padding-left: 20px;">
                        ...
                        <div class="row2"style="padding-left:10px;">
                            ...
                            <div class="row2 cAdv  cTextV2" style="padding-top:12px">
                                ...
                                <input name="button_name" value="{{$package->button_name}}" type="text" maxlength="50" id="ctl00_CPMain_cPackageEdit_cBuyTicketsBtn" class="editText" style="width:260px;" data-validation-avoid-success-tick="1"><br>
                                <p class="hint" style="clear:both;font-size:14px">Leave blank to use the default value: 'Tickets'</p>
                            </div>
                            <br>
                            <div class="row">
                                <span class="editText"><input id="ctl00_CPMain_cPackageEdit_cActive" type="checkbox" name="status" {{ $package->status == 1 ? 'checked':'' }} ><span for="ctl00_CPMain_cPackageEdit_cActive"style="margin-left:5px">Active (Check this box to make the package visible to users)</span></span>
                            </div>
                            <br>
                            <div class="row">
                                <span class="editText"><input id="ctl00_CPMain_cPackageEdit_cHidden" type="checkbox" name="private"  {{ $package->private == 1 ? 'checked':'' }} ><span for="ctl00_CPMain_cPackageEdit_cHidden"style="margin-left:5px">Private (Only Admin, Sales Agents and users who have the direct link have access)</span></span>
                            </div>
                            <br>
                            <div class="row2">
                                ...
                                use App\Models\Category;
                                     ...
                                     $selectedcategory = explode(",", $package->category_id);
                               ...
                               @endphp
                                <div class="row2"style="margin-left:5px;">
                                    <select name="category_id[]"  multiple class="select2" data-placeholder="Select Categorys" style="margin-left:5px;width: 266px;">
                                        ...
                                        <option value="{{$category->id}}" @foreach ($selectedcategory as $catego) {{ $catego == $category->id ? 'selected':'' }} @endforeach>{{$category->category_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                ...
                <input type="text" name="link" value="{{$package->link}}" style="margin-left:10px;"><br>
                ...
                <div class="cCopiable">
                            ...
                            <input type="text"  name="short_link" value="{{$package->short_link}}" style="margin-left:10px;">
                        </div>
                        ...
                        <div class="ro trackingRow"  style="margin-left:10px;">
                           ...
                           <br> --}}
                            ...
                            <div class="row2" style="text-align:center;">
                                ...
                                <button type="submit" class="btn btn-success " style="margin-top: 10px; width:218px"><span>Update </span> &nbsp;&nbsp;</button>
                            </form>
