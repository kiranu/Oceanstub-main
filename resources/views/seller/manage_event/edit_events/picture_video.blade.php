      ...
      <div class="Help" style="float: right;margin:18px;">
       ...
       <!-- <form id="flyer-form" method="POST" action="/seller/add_event_flyer"  enctype="multipart/form-data" >   
                  ...
                  <form id="flyer-form">
                    ...
                    @isset($event_data->event_files)
                    value="{{$event_data->event_files->event_id}}" @endisset>
                    ...
                    <div class="cImageUploader" style="text-align:center;" data-type="EventFlyer" data-uploadfilename="209443" data-noimage="">
                      <div class="row flyerupload1"style="padding-left:400px;">
                        ...
                        <input    type="file" name="flyer" id="flyer"
                         @isset($event_data->event_files->flyer_name) value="{{$event_data->event_files->flyer_name}}" @endisset>
                        <span class="text-danger error-text flyer_error"></span>
                        &nbsp;&nbsp;
...
<div class="row ticket-upload"style="float:left;padding-left:340px;display:inline-block;">
  ...
  @if(@isset($event_data->event_files->flyer_path))

<img id="FlyerPreview" 
src="{{ route('seller.displayflyer',$event_data->event_files->flyer_name)}}" 
style="border-width:1px;border-style:solid;border-radius: 20px;width: 200px;">
...
@if($event_data->event_files)
<img class="pre_preview" id="innerFlyerPreview" src="{{ route('seller.displayflyer',$event_data->event_files->flyer_name)}}" 
>
@else
...
@endif
                    ...
                    <div class="cImageUploader" style="text-align:center;" data-type="TicketAddition" data-uploadfilename="209443" data-noimage="">
                      <div class="row flyerupload2"style="padding-left: 370px;">
                        ...
                        <input type="file" name="picture" id="picture"
                         @isset($event_data->event_files->picture_name) value="{{$event_data->event_files->picture_name}}" @endisset>
                      ...
                      <div class="row">
                          @if($event_data->event_files)
                          <img id="ctl02_cETicketAdditionPreview" 
                          src="{{asset($event_data->event_files->picture_path)}}" 
                          style="border-width: 0px;">
                       
                          @else
                        <img id="ctl02_cETicketAdditionPreview" src="https://ticketor.net/usercontent/0/evt/0.gif" style="border-width: 0px;">
                        @endif
                      </div>
                    </div>
                  </div>
        ...
        <div class="cSeatingChartContainer cAdv" style="padding-left: 10px ;">
                ...
                <input id="yt" type="radio" name="media_link" value="yt"

style="margin-left: 10px;"@isset($event_data->event_files)
{{($event_data->event_files->social_media == "yt" ? ' checked' : '')}}@endisset >
                        ...
                        <tr>
                          <td>
                           <!--  <input id="ctl02_cVideoType_1" type="radio" name="ctl02$cVideoType" value="fb" style="margin-left: 10px; "> -->
                            ...
                            <input id="fb" type="radio" name="media_link" value="fb" style="margin-left: 10px;"@isset($event_data->event_files)
                            {{($event_data->event_files->social_media == "fb" ? ' checked' : '')}}@endisset>
                  ...
                  <span style="padding-left: 10px; ">Video ID:
                    ...
                    id="video_id" 
                    @isset($event_data->event_files)
                    value="{{$event_data->event_files->video_id}}"@endisset 
                     >
