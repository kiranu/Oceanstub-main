  ...
  @include('layouts.seller_navbar')
      ...
      <script type="text/javascript">
       ...
       <form id="seating_chart_form">
          ...
          <textarea id="sketchpaddata" name="SeatingChartData" style="display:none"; rows="5" cols="5"></textarea>

          <input style="width: 24%;margin: 6px 2px 2px 6px;" type="text" placeholder="Seating chart name" class="chartname form-control" name="SeatingChartName">
        ...
        <label class="form-check-label">Private</label>
          ...
          <button type="submit" class="btn btn-success seatingchartSvebtn">Save</button>
...
<script>
    $(document).ready(function () {
        $("#seating_chart_form").submit(function (stay) {
            stay.preventDefault();
            ...
            $.ajax({
                type: "POST",
                url: "{{route('seller.post_SeatingChart')}}",
                data: formdata,
                cache: false,
                processData:false,
                dataType:'json',
