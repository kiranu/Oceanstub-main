          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">About Us: <a href="{{route('seller.content_management.edit_about_us',$policy->id)}}"><i class="fas fa-edit"></i></a></h3>

               
              </div>
              <div class="card-body">
                {!!html_entity_decode($policy->about_us)!!}
