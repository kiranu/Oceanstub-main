          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Privacy Policy: <a href="{{route('seller.content_management.edit_privacy_policy',$policy->id)}}"><i class="fas fa-edit"></i></a></h3>

               
              </div>
              <div class="card-body">
                {!!html_entity_decode($policy->privacy_policy)!!}
